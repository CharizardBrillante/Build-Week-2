    ...
    getDetails() {
        ...
        let details = document.createElement("div");
            details.className = "details";
                ...
                let detailsFront = document.createElement("div");
                    detailsFront.classList = "detailsFront";
                    detailsFront.classList.add("p--hidden");
                        let cPhoto = document.createElement("img");
                            ...
                            let pRotate = document.createElement("div");
                                pRotate.classList = "pRotate";
                                pRotate.textContent = "click to flip the card";
                let detailsBack = document.createElement("div");
